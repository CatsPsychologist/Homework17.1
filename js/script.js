...
// let localDeleteBtn = document.getElementsByClassName('checkbox')
//
// console.log(localDeleteBtn)
//
// localDeleteBtn.addEventListener('submit',){
//
//     let values = JSON.parse(localStorage.todoItems);
//
// }
//
